...
<div class="container">
    <div class="row min-vh-100 justify-content-center align-items-center">
      <div class="col-lg-5">
        ...
        ?>
        <div class="form-wrap border rounded p-4" style="background-color:white">
          <h1>Log In</h1>
          ...
          <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" novalidate>
            ...
            <p class="mb-0" style="color: black;">Don't have an account ? <a href="./register.php" style="color: blue;">Sign Up</a></p>
          </form>
          <!-- form ends here -->
        </div>
      </div>
